				...
				<div class="container">
					<div class="row justify-content-between align-items-center">
						<div class="col-lg-6 col-md-6 search-course-left">
							...
							<p>
								Dengan Kurikulum yang update sesuai kebutuhan dunia kerja,kami menjamin lulusan siap kerja dan bersaing daya guna untuk indonesia yang lebih maju di kancah dunia
							</p>
							
						</div>
						<div class="col-lg-6 col-md-6 search-course-right section-gap">
							{!! Form::open(['url' => '/postregister','class'=>'form-wrap']) !!}
								<h4 class=" pb-20 text-center mb-30">Formulir Pendftaran Online</h4>
